...
import top.limbang.mcsm.command.GroupConfigCompositeCommand
import top.limbang.mcsm.command.MCSMCompositeCommand
import top.limbang.mcsm.command.MCSMCompositeCommand.apiMap
import top.limbang.mcsm.command.MCSMCompositeCommand.renameInstance
import top.limbang.mcsm.command.MCSMListener
import top.limbang.mcsm.command.ModCompositeCommand
...
object MCSM : KotlinPlugin(
    ...
    private fun initAPI() {
        mcsmList.forEach {
            val apiService = RetrofitClient(it.url).create<MCSManagerApi>()
